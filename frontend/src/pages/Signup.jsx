  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F7F4EC', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'sans-serif' }}>
      <div style={{ background: '#FEFDF9', border: '1px solid rgba(14,26,20,0.12)', borderRadius: '16px', padding: '2rem', width: '360px', boxShadow: '0 8px 30px -12px rgba(0,0,0,0.15)' }}>
        <h1 style={{ color: '#0F4230', fontSize: '1.6rem', marginBottom: '0.3rem' }}>Create your account</h1>
        <p style={{ color: '#5A6960', fontSize: '0.9rem', marginBottom: '1.5rem' }}>Start your investing journey</p>
        ...
        <button onClick={handleSignup} style={{ width: '100%', padding: '0.8rem', borderRadius: '10px', border: 'none', background: '#1B6B4C', color: '#fff', fontWeight: '500', cursor: 'pointer', fontSize: '0.95rem', marginBottom: '1rem' }}>
          Sign up
        </button>

        <p style={{ textAlign: 'center', fontSize: '0.85rem', color: '#5A6960' }}>
          Already have an account? <Link to="/login" style={{ color: '#1B6B4C', fontWeight: '500' }}>Log in</Link>
        </p>
      </div>
    </div>
  );
